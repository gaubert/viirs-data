...
class TiePointGridCreatorBase(object):
    ...
    GROUP_CORR = 'VIIRS-MOD-GEO-TC_All'
    GROUP_NON_CORR = 'VIIRS-MOD-GEO_All'
    ...
    def extract_geo_spatial_reducable_data(cls, geo_file):
        ...
        lat = geo_file['All_Data'][cls.GROUP_CORR]['Latitude']
        #compute_variation(lat,768, 3200)
        lon = geo_file['All_Data'][cls.GROUP_CORR]['Longitude']
        
        #compute_variation(lon,768, 3200)
        
        out['Latitude']              = lat[:]
        out['Longitude']             = lon[:]
        out['Height']                = geo_file['All_Data'][cls.GROUP_CORR]['Height'][:]
        out['SolarZenithAngle']      = geo_file['All_Data'][cls.GROUP_CORR]['SolarZenithAngle'][:]
        out['SolarAzimuthAngle']     = geo_file['All_Data'][cls.GROUP_CORR]['SolarAzimuthAngle'][:]
        out['SatelliteZenithAngle']  = geo_file['All_Data'][cls.GROUP_CORR]['SatelliteZenithAngle'][:]
        out['SatelliteAzimuthAngle'] = geo_file['All_Data'][cls.GROUP_CORR]['SatelliteAzimuthAngle'][:]
        out['QF2_VIIRSSDRGEO']       = geo_file['All_Data'][cls.GROUP_CORR]['QF2_VIIRSMODGEOTC'][:]
    ...
    def extract_additional_geoloc_info(cls, geo_file):
        ...
        """
        out = {}
        out['MidTime']               = geo_file['All_Data'][cls.GROUP_CORR]['MidTime'][:]
        out['ModeGran_Geo']          = geo_file['All_Data'][cls.GROUP_CORR]['ModeGran'][:]
        out['ModeScan_Geo']          = geo_file['All_Data'][cls.GROUP_CORR]['ModeScan'][:]
        out['NumberOfScans_Geo']     = geo_file['All_Data'][cls.GROUP_CORR]['NumberOfScans'][:]
        out['PadByte1_Geo']          = geo_file['All_Data'][cls.GROUP_CORR]['PadByte1'][:]
        out['QF1_SCAN_VIIRS_SDRGEO'] = geo_file['All_Data'][cls.GROUP_CORR]['QF1_SCAN_VIIRSMODGEOTC'][:]
        out['StartTime']             = geo_file['All_Data'][cls.GROUP_CORR]['StartTime'][:]
...
if __name__ == '__main__':
    ...
    granules_name = ['d20120528_t2043254_e2044495_b00001', 'd20120528_t2044508_e2046149_b00001', 'd20120528_t2046162_e2047403_b00001', 'd20120528_t2047416_e2049060_b00001']
    ...
    for granule_name in granules_name:
        ...
        reducer.create_aggregated_viirs_dataset('/tmp/reduced_eum_reg_%s.h5' % (granule_name))
